...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP_ANSI(
    ...
    LCTL,LGUI,LALT,          SPC,                     RALT, FN2, FN1, FN0),
  ...
  /* 5: Mouse Mode */
  KEYMAP_ANSI(
    U,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, \
  ...
  /* 6: Layout selector */
  KEYMAP_ANSI(
    TRNS, FN4, FN5, FN6, FN7,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, \
